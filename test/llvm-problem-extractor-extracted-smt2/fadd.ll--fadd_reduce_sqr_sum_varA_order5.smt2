; SMT-LIB extracted from file '../../llvm-project/llvm/test/Transforms/InstCombine/fadd.ll' from function 'fadd_reduce_sqr_sum_varA_order5'
; 
...
(assert
 ...
 (let ((?x11 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven (_ +zero 8 24) a) b)))
