; SMT-LIB extracted from file '../../llvm-project/llvm/test/Transforms/InstCombine/fadd.ll' from function 'fadd_reduce_sqr_sum_varB_invalid2'
; 
...
(assert
 ...
 (let ((?x8 (fp.mul roundNearestTiesToEven a b)))
