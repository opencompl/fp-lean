; SMT-LIB extracted from file '../../llvm-project/llvm/test/Transforms/InstCombine/fadd.ll' from function 'fadd_reduce_sqr_sum_varB2_order2'
; 
...
(assert
 ...
 (let ((?x10 (fp.mul roundNearestTiesToEven b (fp.mul roundNearestTiesToEven a (_ +zero 8 24)))))
