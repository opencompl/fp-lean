; SMT-LIB extracted from file '../../llvm-project/llvm/test/Transforms/InstCombine/fadd.ll' from function 'fadd_reduce_sqr_sum_varB2_order3'
; 
...
(assert
 ...
 (let ((?x10 (fp.mul roundNearestTiesToEven (fp.mul roundNearestTiesToEven (_ +zero 8 24) a) b)))
