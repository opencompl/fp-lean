; SMT-LIB extracted from file '../../llvm-project/llvm/test/Transforms/InstCombine/fadd.ll' from function 'fadd_reduce_sqr_sum_varB_order2'
; 
...
(assert
 ...
 (let ((?x13 (fp.add roundNearestTiesToEven (fp.mul roundNearestTiesToEven b b) (fp.mul roundNearestTiesToEven a a))))
