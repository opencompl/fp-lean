; SMT-LIB extracted from file '../../llvm-project/llvm/test/Transforms/InstCombine/fadd.ll' from function 'fmul_fneg2_commute'
; 
...
(assert
 (let ((?x9 (fp.rem (fp #b0 #b10000000100 #x4800000000000) py)))
 ...
 (let ((?x16 (fp.add roundNearestTiesToEven ?x15 ?x11)))
